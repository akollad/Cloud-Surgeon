                  ...
                  <div className="space-y-4">
                    {handoffs.map((h, i) => (
                      <div key={i} className="flex items-start gap-4">
                        <div className="min-w-24 text-xs font-mono text-muted-foreground pt-1">{formatDate(h.handoffAt)}</div>
                        <div className="flex-1 border border-border p-3 bg-muted/10 font-mono text-sm">
                          <div className="flex items-center gap-2 mb-2">
                            <Badge variant="outline" className="text-primary border-primary/30">{h.fromAgent}</Badge>
                            <ArrowRight className="w-4 h-4 text-muted-foreground" />
                            <Badge variant="outline" className="text-primary border-primary/30">{h.toAgent}</Badge>
                          </div>
                          <div className="text-muted-foreground text-xs leading-relaxed">{h.summary}</div>
                        </div>
                      </div>
                    ))}
                  </div>
